"""Allowed output values, mirroring the prediction contract in docs/data-contract.md.
...
CLAIM_STATUSES: frozenset[str] = frozenset({"supported", "contradicted", "not_enough_information"})
...
# Exact output column order required by the prediction contract (docs/data-contract.md).
